...
/* harmony import */ var _context_AuthContext__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12622);
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(57125);
/* __next_internal_client_entry_do_not_use__ default auto */ 



const initials = (name, email)=>(name.trim() || email).split(/\s+/).slice(0, 2).map((x)=>x[0]).join("").toUpperCase();
function Account() {
    const { session, setSession } = (0,_context_AuthContext__WEBPACK_IMPORTED_MODULE_2__/* .useAuth */ .A)();
    if (!session) return null;
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Profile, {
        email: session.user.email,
        initial: session.user.displayName,
        saved: (name)=>setSession({
                ...session,
                user: {
                    ...session.user,
                    displayName: name
...
function Profile({ email, initial, saved }) {
    const [name, setName] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(initial), [baseline, setBaseline] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(initial.trim()), [busy, setBusy] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false), [notice, setNotice] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(""), [error, setError] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(""), [password, setPassword] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false), [current, setCurrent] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(""), [next, setNext] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
    ...
    async function save(e) {
        ...
        setError("");
        try {
            const p = await (0,_lib_api__WEBPACK_IMPORTED_MODULE_3__/* .getApiClient */ .e)().updateProfile(name.trim());
    ...
    async function change(e) {
        ...
        setError("");
        try {
            await (0,_lib_api__WEBPACK_IMPORTED_MODULE_3__/* .getApiClient */ .e)().changePassword({
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("header", {
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
                        children: "Quản l\xfd danh t\xednh hiển thị v\xe0 th\xf4ng tin đăng nhập."
                    })
                ]
            }),
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("b", {
                                children: name.trim() || "Chưa đặt tên"
                            }),
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("label", {
                        children: [
                            "Email ",
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("small", {
                                children: "KH\xd4NG THỂ THAY ĐỔI"
                            }),
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", {
                                value: email,
                                readOnly: true
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("button", {
                                disabled: !dirty || busy,
                                children: busy ? "Đang lưu…" : "Lưu thay đổi →"
                            })
                        ]
                    })
                ]
            }),
            password && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("input", {
                        ...
                        minLength: 12,
                        placeholder: "Mật khẩu mới \xb7 tối thiểu 12 k\xfd tự",
                        required: true
                    }),
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        className: "account-actions",
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 36876));
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87510));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_server_dom_webpack_server__WEBPACK_IMPORTED_MODULE_0__.registerClientReference)(
function() { throw new Error("Attempted to call the default export of \"C:\\\\NDT\\\\PJ\\\\Ai_Security-main\\\\frontend\\\\web\\\\app\\\\account\\\\page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component."); },
"C:\\NDT\\PJ\\Ai_Security-main\\frontend\\web\\app\\account\\page.tsx",
"default",
));
...
const page6 = () => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87510));
...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [page6, "C:\\NDT\\PJ\\Ai_Security-main\\frontend\\web\\app\\account\\page.tsx"],
...
const pages = ["C:\\NDT\\PJ\\Ai_Security-main\\frontend\\web\\app\\account\\page.tsx"];
...
var __webpack_exports__ = __webpack_require__.X(0, [331,754,515,837], () => (__webpack_exec__(94701)));
