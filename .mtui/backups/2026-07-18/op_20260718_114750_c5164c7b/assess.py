...
from backend.services.ai_context_weight_service import get_ai_context_weight_percent
...
def assess_url(
    ...
    result = _cached_url_result(db, url, context, cache_namespace)
    if result is None:
        reserved_ai = (
            context_mode != "off"
        ...
        _store_url_result(db, url, result, context, cache_namespace)
