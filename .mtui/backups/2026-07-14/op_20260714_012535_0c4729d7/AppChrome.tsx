...
export default function AppChrome({ children }: AppChromeProps): JSX.Element {
    ...
    if (pathname === "/armor-console" || pathname?.startsWith("/analyze") || pathname?.startsWith("/result") || pathname === "/history" || pathname === "/methodology" || pathname === "/settings" || pathname?.startsWith("/account") || pathname === "/downloads" || pathname === "/sandbox" || pathname === "/pricing") {
        return <>{children}</>;
    }
