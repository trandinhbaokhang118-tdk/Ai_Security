...
class MCPTools:
    ...
    def assess_text(self, payload: TextInput) -> dict[str, Any]:
        ...
        response["injection_detected"] = any(
            item.source == "prompt_adapter" and item.severity.value in {"high", "critical"}
    ...
    def assess_page(self, payload: PageInput) -> dict[str, Any]:
        ...
        result = self.service.assess_text(content, "text", {"url": payload.url, "source": "page"})
        return _assessment_json(result)
