...
**3 MCP Tools:**
- `check_url_before_click` - Kiểm tra URL trước khi click
- `check_content_before_processing` - Kiểm tra nội dung trước khi xử lý
- `check_action_before_execution` - Kiểm tra action trước khi thực hiện
...
- [`docs/TRAINING.md`](docs/TRAINING.md) - Hướng dẫn training models
- [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md) - Hướng dẫn deploy production
- [`docs/MCP.md`](docs/MCP.md) - Tích hợp MCP Server
...
- [ ] Demo/Showcase System (xem `.kiro/specs/demo-showcase-system/`)
